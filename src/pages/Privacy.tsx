/*
 * @Author:FeiFeiSeal
 * @Date:2025-04-11 14:34:15
 * @LastEditors:FeiFeiSeal
 * @LastEditTime:2025-05-15 15:27:27
 * @Description:
 */
...
export const Privacy = () => {
  return (
    <>
      <div className=" border-x border-foreground/15 border-dashed">
        <section className="relative">
          <div className="">
            <div className="" id="en">
              <div className="bg-background/5 backdrop-blur-xs border-b border-foreground/15 border-dashed">
                <div className="container border-x border-foreground/15 border-dashed">
                  <div className="">
              ...
              <div className="container border-x border-foreground/15 border-dashed">
                <h2 className="text-3xl py-2 mb-5 font-semibold">
                  Interpretation and Definitions
                </h2>
                <h3 className="text-2xl mb-4 py-2 font-semibold">Interpretation</h3>
                <p className="mb-4">
                ...
                <h3 className="text-2xl mb-4 py-2 font-semibold">Definitions</h3>
                <p className="mb-4">For the purposes of this Privacy Policy:</p>
                <ul className="pl-8">
                  <li className="mb-4 before:size-1.5 flex gap-2 before:bg-foreground before:shrink-0 before:rounded-full before:mt-3">
                    <p>
                  ...
                  <li className="mb-4 before:size-1.5 flex gap-2 before:bg-foreground before:shrink-0 before:rounded-full before:mt-3">
                    <p>
                      ...
                      Next Innovation Ltd., 3F.-3, No. 186, Shizheng N. 7th Rd.,
                      Xitun Dist., Taichung City 407612 , Taiwan (R.O.C.).
                    </p>
                  </li>
                  <li className="mb-4 before:size-1.5 flex gap-2 before:bg-foreground before:shrink-0 before:rounded-full before:mt-3">
                    <p>
                  ...
                  <li className="mb-4 before:size-1.5 flex gap-2 before:bg-foreground before:shrink-0 before:rounded-full before:mt-3">
                    <p>
                      <strong>Website</strong> refers to JOSUI, accessible from{' '}
                      <a
                        href="https://josui.design/"
                ...
                <h3 className="text-2xl mb-4 py-2 font-semibold">
                  Types of Data Collected
                </h3>
                <h4 className="text-xl mb-4 font-semibold">Personal Data</h4>
                <p className="mb-4">
                ...
                <h4 className="text-xl mb-4 font-semibold">Usage Data</h4>
                <p className="mb-4">
                ...
                <h4 className="text-xl mb-4 font-semibold">Law enforcement</h4>
                <p className="mb-4">
                ...
                <h2 className="text-3xl py-2 mb-5 font-semibold">Contact Us</h2>
                <p className="mb-4">
